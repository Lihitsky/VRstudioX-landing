    ...
    <div className="mt-20">
      ...
      <ul className="flex flex-wrap">
        {pricingOptions.map((option, index) => (
          <li key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
            <div className="p-10 border border-neutral-700 rounded-xl">
              <p className="text-4xl mb-8">
                {option.title}
                {option.title === "Pro" && (
                  <span className="bg-gradient-to-r from-[#FAD36F] to-[#E0FF1F] text-transparent bg-clip-text text-xl mb-4 ml-2">
                    (Most Popular)
                  </span>
                )}
              </p>
